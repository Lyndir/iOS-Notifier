...
public class APNServerConfig {
     ...
     * 
     * <p>
     * You'll need a TLSv1 supporting server running on <code>localhost</code> at ports <code>2195</code> (APNs) and
     * <code>2196</code> (Feedback service). You could, for example, use <code>stunnel</code> & <code>netcat</code> for
     * this purpose.
     * </p>
     */
     ...
     * 
     * @param apnsHostname
     *            The hostname of the Apple Push Notification server.
     * @param apnsPort
     *            The port of the Apple Push Notification server socket.
     * @param feedBackHostname
     *            The hostname of the Apple Push Notification Feedback service.
     * @param feedBackPort
     *            The port of the Apple Push Notification Feedback service socket.
     ...
     * 
     * @param apnsAddress
     *            The hostname and port of the Apple Push Notification server socket.
     * @param feedBackAddress
     *            The hostname and port of the Apple Push Notification Feedback service socket.
     * @param encryptionProtocol
     *            The SSL/TLS protocol to use for transport encryption to these servers.
     */
